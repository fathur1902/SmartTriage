      ...
      >
        ...
        <nav className="p-4 space-y-4 overflow-y-auto h-full pb-20">
          <div className="mb-6 px-2">
            <h2 className="text-2xl font-bold text-teal-600">Menu Admin</h2>
          ...
          <Link
            ...
            className="flex items-center space-x-3 p-3 rounded-lg hover:bg-teal-50 text-teal-700 transition-colors"
          >
            <FiUserPlus className="text-xl" /> <span>Buat Akun Dokter</span>
          </Link>
          <Link
            to="/admin/kelola-pasien"
            className="flex items-center space-x-3 p-3 rounded-lg hover:bg-teal-50 text-teal-700 transition-colors"
          >
            <FiUsers className="text-xl" /> <span>Kelola Akun Pasien</span>
          </Link>
          <Link
            to="/admin/kelola-dokter"
            className="flex items-center space-x-3 p-3 rounded-lg hover:bg-teal-50 text-teal-700 transition-colors"
          >
            <FiActivity className="text-xl" /> <span>Kelola Akun Dokter</span>
          </Link>
          <Link
            to="/admin/profile"
            className="flex items-center space-x-3 p-3 rounded-lg hover:bg-teal-50 text-teal-700 transition-colors"
